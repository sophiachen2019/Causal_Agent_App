...
- **Quasi-Experimental Analysis**: Dedicated modules for **Difference-in-Differences (DiD)**, **Switchback Analysis**, **Interrupted/Bayesian Time Series (ITS/BSTS)**, and **GeoLift (Synthetic Control via R)** for panel and geographic split-testing data.
